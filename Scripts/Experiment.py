...
The main task consists of recreating Lego structures with limited time.
Before and after this task you will be asked to estimate the duration of a tone being played to you. \n
...
trial = '''Here is a single trial, so you know what to do moving forward. \n
Press SPACE to start the trial.'''
start = '''Great job, now lets do it for real \n
...
Lego = '''Wait for further instructions!'''
