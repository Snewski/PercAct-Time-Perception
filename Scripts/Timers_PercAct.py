...
def start_timer(speed):
    ...
    timer_label = tk.Label(new_window, text=f"Time Left: 05:00", font=("Helvetica", 16))
...
button_1 = tk.Button(button_frame, text="1", command=lambda: start_timer(0.8), height=2, width=5)
...
button_3 = tk.Button(button_frame, text="3", command=lambda: start_timer(1.2), height=2, width=5)
